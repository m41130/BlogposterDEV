...
(async () => {
  try {
    ...
    if (lane !== 'admin') {
      ...
      const grid = GridStack.init({ staticGrid: true, float: true, cellHeight: 5, columnWidth: 5, column: 24 }, gridEl);
    ...
    const grid = GridStack.init({ cellHeight: 5, columnWidth: 5, column: 24 }, gridEl);
